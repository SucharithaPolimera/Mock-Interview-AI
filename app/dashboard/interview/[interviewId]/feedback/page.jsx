    ...
    return (
        <div className='p-10'>
            ...
            : <>
                ...
                <h2 className='text-primary text-lg my-3'>Your over all interview rating: <strong>7/10</strong></h2>
                        ...
                        <Collapsible key={index} className="mt-7">
                            ...
                            <CollapsibleContent>
                                <div className='flex flex-col gap-2'>
                                    <h2 className='text-red-500 border p-2 rounded-lg'><strong>Rating: </strong>{item.rating}</h2>
